...
class TestAsset(RWTestCase):
    ...
    #def test_clean_fields(self, exclude=None):
        #self.assertEquals('', self.asset1.clean_fields())
        #self.assertEquals('latitude': [u'This field cannot be blank.'], 'project': [u'This field cannot be blank.'], 'language': [u'This field cannot be blank.'], 'longitude': [u'This field cannot be blank.'], 'initialenvelope': [u'This field cannot be blank.'], self.asset1.clean_fields())
        #output = ""
        #sequence = "'latitude': [u'This field cannot be blank.'], 'project': [u'This field cannot be blank.'], 'language': [u'This field cannot be blank.'], 'longitude': [u'This field cannot be blank.'], 'initialenvelope': [u'This field cannot be blank.']"
        #self.assertEquals(output.join(sequence), self.asset1.clean_fields())
    
    #def test_validate_filetype_for_mediatype(self, content_type):
    #    self.assertEquals(1, self.asset1.validate_filetype_for_mediatype(content_type))
    
    # Karl
    def test_media_display(self):
        self.assertEquals(self.asset1.audio_player(), self.asset1.media_display())
        #if (self.asset1.mediatype == 'audio'):
        #    self.assertEquals('<div data-filename="None" class="media-display audio-file"></div>', self.asset1.media_display())
        #if (self.asset1.mediatype == 'audio'):
        #    self.assertEquals(self.asset1.audio_player(), self.asset1.media_display())
        #elif (self.asset1.mediatype == 'photo'):
        #    self.assertEquals(self.asset1.image_display(), self.asset1.media_display())
        #elif (self.asset1.mediatype == 'text'):
        #    self.assertEquals(self.asset1.text_display(), self.asset1.media_display())
        #else:
        #    self.assertEquals('', self.asset1.media_display())
    ...
    def test_audio_player(self):
        ...
        #self.assertEquals(self.asset1.audio_player(), self.asset1.audio_player())
    ...
    def test_image_display(self):
        ...
        #self.assertEquals(self.asset1.image_display(), self.asset1.image_display())
    ...
    def test_text_display(self):
        ...
        #self.assertEquals(self.asset1.text_display(), self.asset1.text_display())
    ...
    def test_location_map(self):
        ...
        #self.assertEquals(self.asset1.location_map(), self.asset1.location_map())
    ...
    def test_norm_audiolength(self):
        ...
        #self.assertEquals(None, self.asset1.norm_audiolength())
        #self.assertEquals('', self.asset1.norm_audiolength())
        #if self.asset2.audiolength:
        #if self.asset1.audiolength:
        #    self.assertEquals('', self.asset1.norm_audiolength())
        #self.assertEquals(None, self.asset1.norm_audiolength())
        #self.assertEquals(None, self.asset2.norm_audiolength())
    #    if self.audiolength:
    ...
    def test_get_votes(self):
        ...
        #self.assertEquals("like : 0", self.asset2.get_votes())
        #self.assertEquals(self.vote1, self.asset1.get_votes())
        #self.assertEquals(self.vote2, self.asset1.get_votes())
        #self.assertEquals(self.vote3, self.asset1.get_votes())
        #self.assertEquals(self.vote4, self.asset1.get_votes())
        #self.assertEquals(1, self.asset1.get_votes())
        
    # Karl
    #def test_distance(self):
        #self.assertEquals(self.asset1.distance([self.asset1, self.asset1]), self.asset1.distance())
...
class TestSpeaker(RWTestCase):
    ...
    def test_location_map(self):
        ...
        #self.assertEquals(self.project.location_map(), self.project.location_map())
