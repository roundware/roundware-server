...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Asset.initialenvelope'
        db.add_column('rw_asset', 'initialenvelope',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rw.Envelope'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Asset.initialenvelope'
        db.delete_column('rw_asset', 'initialenvelope_id')
