...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field loc_description on 'Asset'
        db.create_table('rw_asset_loc_description', (
        ...
        db.create_unique('rw_asset_loc_description', ['asset_id', 'localizedstring_id'])


    def backwards(self, orm):
        # Removing M2M table for field loc_description on 'Asset'
        db.delete_table('rw_asset_loc_description')
    ...
    models = {
        'rw.asset': {
            ...
            'loc_description': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['rw.LocalizedString']", 'null': 'True', 'blank': 'True'}),
        ...
        'rw.tag': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'loc_description': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'tag_desc'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['rw.LocalizedString']"}),
