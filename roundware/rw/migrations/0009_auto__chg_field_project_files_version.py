...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('rw_project', 'files_version', self.gf('django.db.models.fields.CharField')(max_length=16))

    def backwards(self, orm):

        # Changing field 'Project.files_version'
        db.alter_column('rw_project', 'files_version', self.gf('django.db.models.fields.IntegerField')(max_length=10))
