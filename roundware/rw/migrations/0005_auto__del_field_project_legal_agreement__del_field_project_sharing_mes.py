...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Project.legal_agreement'
        db.delete_column('rw_project', 'legal_agreement')

        # Deleting field 'Project.sharing_message'
        db.delete_column('rw_project', 'sharing_message')

        # Deleting field 'Project.out_of_range_message'
        db.delete_column('rw_project', 'out_of_range_message')


    def backwards(self, orm):
        # Adding field 'Project.legal_agreement'
        db.add_column('rw_project', 'legal_agreement',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.sharing_message'
        db.add_column('rw_project', 'sharing_message',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.out_of_range_message'
        db.add_column('rw_project', 'out_of_range_message',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
