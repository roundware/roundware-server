...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Asset.mediatype'
        db.add_column('rw_asset', 'mediatype',
                      self.gf('django.db.models.fields.CharField')(default='audio', max_length=16),
                      keep_default=False)

        # Adding field 'Asset.description'
        db.add_column('rw_asset', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=2048, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Asset.mediatype'
        db.delete_column('rw_asset', 'mediatype')

        # Deleting field 'Asset.description'
        db.delete_column('rw_asset', 'description')
