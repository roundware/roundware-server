...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Asset.weight'
        db.add_column('rw_asset', 'weight',
                      self.gf('django.db.models.fields.IntegerField')(default=50),
                      keep_default=False)

        # Adding field 'Project.ordering'
        db.add_column('rw_project', 'ordering',
                      self.gf('django.db.models.fields.CharField')(default='random', max_length=16),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Asset.weight'
        db.delete_column('rw_asset', 'weight')

        # Deleting field 'Project.ordering'
        db.delete_column('rw_project', 'ordering')
