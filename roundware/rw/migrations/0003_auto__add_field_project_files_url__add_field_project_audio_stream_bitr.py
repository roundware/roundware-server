...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.audio_stream_bitrate'
        db.add_column('rw_project', 'audio_stream_bitrate',
                      self.gf('django.db.models.fields.CharField')(default=4, max_length=3),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Project.audio_stream_bitrate'
        db.delete_column('rw_project', 'audio_stream_bitrate')
    ...
    models = {
        ...
        'rw.project': {
            ...
            'audio_stream_bitrate': ('django.db.models.fields.CharField', [], {'default': '4', 'max_length': '3'}),
