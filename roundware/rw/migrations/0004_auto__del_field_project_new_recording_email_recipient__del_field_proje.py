...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Project.new_recording_email_recipient'
        db.delete_column('rw_project', 'new_recording_email_recipient')

        # Deleting field 'Project.new_recording_email_body'
        db.delete_column('rw_project', 'new_recording_email_body')


    def backwards(self, orm):
        # Adding field 'Project.new_recording_email_recipient'
        db.add_column('rw_project', 'new_recording_email_recipient',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)

        # Adding field 'Project.new_recording_email_body'
        db.add_column('rw_project', 'new_recording_email_body',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)
