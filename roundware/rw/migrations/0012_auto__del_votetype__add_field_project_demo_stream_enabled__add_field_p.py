...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        #db.delete_table('rw_votetype') this was never added in any migration

        # Adding field 'Project.demo_stream_enabled'
        db.add_column('rw_project', 'demo_stream_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Project.demo_stream_url'
        db.add_column('rw_project', 'demo_stream_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True),
                      keep_default=False)

        # Adding M2M table for field demo_stream_message_loc on 'Project'
        db.create_table('rw_project_demo_stream_message_loc', (
        ...
        db.create_unique('rw_project_demo_stream_message_loc', ['project_id', 'localizedstring_id'])

        # Deleting field 'Vote.type_fk'
        #db.delete_column('rw_vote', 'type_fk_id')


    def backwards(self, orm):
        # Adding model 'VoteType'
        # db.create_table('rw_votetype', (
        #     ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        #     ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        # ))
        # db.send_create_signal('rw', ['VoteType'])

        # Deleting field 'Project.demo_stream_enabled'
        db.delete_column('rw_project', 'demo_stream_enabled')

        # Deleting field 'Project.demo_stream_url'
        db.delete_column('rw_project', 'demo_stream_url')

        # Removing M2M table for field demo_stream_message_loc on 'Project'
        db.delete_table('rw_project_demo_stream_message_loc')

        # Adding field 'Vote.type_fk'
        # db.add_column('rw_vote', 'type_fk',
        #               self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rw.VoteType'], null=True),
        #               keep_default=False)
