...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field relationships on 'Tag'
        db.create_table('rw_tag_relationships', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_tag', models.ForeignKey(orm['rw.tag'], null=False)),
            ('to_tag', models.ForeignKey(orm['rw.tag'], null=False))
        ))
        db.create_unique('rw_tag_relationships', ['from_tag_id', 'to_tag_id'])


    def backwards(self, orm):
        # Removing M2M table for field relationships on 'Tag'
        db.delete_table('rw_tag_relationships')
    ...
    models = {
        ...
        'rw.tag': {
            ...
            'relationships': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'related_to'", 'symmetrical': 'False', 'to': "orm['rw.Tag']"}),
            'tag_category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rw.TagCategory']"}),
