...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field header_text_loc on 'MasterUI'
        db.create_table('rw_masterui_header_text_loc', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('masterui', models.ForeignKey(orm['rw.masterui'], null=False)),
            ('localizedstring', models.ForeignKey(orm['rw.localizedstring'], null=False))
        ))
        db.create_unique('rw_masterui_header_text_loc', ['masterui_id', 'localizedstring_id'])


    def backwards(self, orm):
        # Removing M2M table for field header_text_loc on 'MasterUI'
        db.delete_table('rw_masterui_header_text_loc')
    ...
    models = {
        ...
        'rw.tag': {
            ...
            'relationships': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'related_to'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['rw.Tag']"}),
            'tag_category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rw.TagCategory']"}),
