...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.files_version'
        db.add_column('rw_project', 'files_version',
                      self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.files_version'
        db.delete_column('rw_project', 'files_version')
    ...
    models = {
        ...
        'rw.project': {
            ...
            'files_version': ('django.db.models.fields.IntegerField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
