...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.files_version'
        db.alter_column('rw_project', 'files_version', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10))

    def backwards(self, orm):

        # Changing field 'Project.files_version'
        db.alter_column('rw_project', 'files_version', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))
    ...
    models = {
        ...
        'rw.project': {
            ...
            'files_version': ('django.db.models.fields.IntegerField', [], {'max_length': '10', 'blank': 'True'}),
