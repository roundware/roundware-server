...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field loc_description on 'Tag'
        db.create_table('rw_tag_loc_description', (
        ...
        db.create_unique('rw_tag_loc_description', ['tag_id', 'localizedstring_id'])


    def backwards(self, orm):
        # Removing M2M table for field loc_description on 'Tag'
        db.delete_table('rw_tag_loc_description')
