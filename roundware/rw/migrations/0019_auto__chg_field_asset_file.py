...
default_file = File(open('files/rw_test_audio1.wav'))
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('rw_asset', 'file', self.gf('roundware.rw.fields.RWValidatedFileField')(default=default_file, max_length=100))
