...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ModelNotification'
        db.create_table('notifications_modelnotification', (
        ...
        db.send_create_signal('notifications', ['ModelNotification'])

        # Adding model 'ActionNotification'
        db.create_table('notifications_actionnotification', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ...
            ('notification', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['notifications.ModelNotification'])),
            ('last_sent_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 12, 13, 0, 0), null=True)),
            ('last_sent_reference', self.gf('django.db.models.fields.IntegerField')(null=True)),
        ))
        db.send_create_signal('notifications', ['ActionNotification'])

        # Adding M2M table for field who on 'ActionNotification'
        db.create_table('notifications_actionnotification_who', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('actionnotification', models.ForeignKey(orm['notifications.actionnotification'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('notifications_actionnotification_who', ['actionnotification_id', 'user_id'])


    def backwards(self, orm):
        # Deleting model 'ModelNotification'
        db.delete_table('notifications_modelnotification')

        # Deleting model 'ActionNotification'
        db.delete_table('notifications_actionnotification')

        # Removing M2M table for field who on 'ActionNotification'
        db.delete_table('notifications_actionnotification_who')
